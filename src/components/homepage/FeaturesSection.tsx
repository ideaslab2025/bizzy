...
export const FeaturesSection = () => {
  return (
    <section id="features" className="pt-24 pb-12 bg-muted">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-6 text-center text-secondary">Everything You Need After Forming Your Company</h2>
        <p className="text-xl mb-10 text-center text-foreground max-w-3xl mx-auto">Bizzy provides all the tools and guidance you need to navigate the complex world of business set-up administration</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-5xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-radial from-blue-500/30 via-blue-700/30 to-blue-900/40 border border-blue-700/50 shadow-lg transform transition-all hover:scale-105 hover:shadow-blue-500/20 hover:shadow-xl group">
            ...
            <div className="p-3 z-10 relative flex flex-col h-full">
              ...
              <div className="mt-6 mb-4">
                <h3 className="text-lg font-bold text-secondary mb-2 text-center">Step-by-Step Guidance</h3>
                <p className="text-foreground text-center text-sm">Comprehensive step by step guidance across HR, Finance, Accounting, Payroll, Compliance and more, with skippable sections </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-radial from-blue-400/30 via-blue-600/30 to-blue-800/40 border border-blue-600/50 shadow-lg transform transition-all hover:scale-105 hover:shadow-blue-500/20 hover:shadow-xl group">
            ...
            <div className="p-3 z-10 relative flex flex-col h-full">
              ...
              <h3 className="text-lg font-bold text-secondary mb-1 text-center">Document Engine</h3>
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-radial from-blue-500/30 via-blue-700/30 to-blue-900/40 border border-blue-700/50 shadow-lg transform transition-all hover:scale-105 hover:shadow-blue-500/20 hover:shadow-xl group">
            ...
            <div className="p-3 z-10 relative flex flex-col h-full">
              ...
              <h3 className="text-lg font-bold text-secondary mb-1 text-center">Bizzy AI Assistant</h3>
              <p className="text-foreground text-center text-sm">
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-radial from-blue-400/30 via-blue-600/30 to-blue-800/40 border border-blue-600/50 shadow-lg transform transition-all hover:scale-105 hover:shadow-blue-500/20 hover:shadow-xl group">
            ...
            <div className="p-3 z-10 relative flex flex-col h-full">
              ...
              <h3 className="text-lg font-bold text-secondary mb-1 text-center">Video Explainers</h3>
              <p className="text-foreground text-center text-sm">
        ...
        <div className="flex justify-start max-w-5xl mx-auto mt-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full">
            <div className="md:col-span-2 lg:col-span-2 flex justify-center">
              <a href="/disclaimer" className="text-secondary hover:text-primary text-sm underline">
                Read our disclaimer
              </a>
            </div>
          </div>

...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r-0 w-[240px] max-w-[240px] fixed left-0 top-0 h-screen z-50">
      <SidebarContent className="bg-[#0088cc] text-white h-full sticky top-0">
          ...
          <div className="absolute bottom-2 left-2 right-2 hidden md:block">
            <div className="flex justify-center">
              <img 
                ...
                alt="Bizzy Logo" 
                className="h-48 w-auto brightness-0 invert opacity-90"
                style={{ 
                  pointerEvents: 'none',

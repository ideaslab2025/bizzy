...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r-0">
      <SidebarContent className="bg-[#0088cc] text-white">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#0088cc] to-transparent pointer-events-none" />
      </SidebarContent>
    </Sidebar>
  )
}
